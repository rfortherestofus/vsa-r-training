...
participants_2022_vsa <- read_sheet("https://docs.google.com/spreadsheets/d/1dOmS1x6yo_d_A78gS-cdxDinKX7Hmb1K_8f7dB8VHkY/edit#gid=0") %>% 
  clean_names()

geocoded_participants <- participants_2022_vsa %>% 
  select(city, country) %>% 
  geocode(city = city,
          country = country,
          method = "iq")
...
pre_survey <- read_sheet("https://docs.google.com/spreadsheets/d/1oQ3pPPKfZkegrumf0OS3omI2TjP8duKFFZU8d2tlX_g/edit") %>% 
  clean_names()
```


```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
pre_survey_vsa_2022 <- pre_survey %>% 
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
data_viz_expertise <- pre_survey_vsa_2022 %>% 
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
how_terrified <- pre_survey_vsa_2022 %>% 
...
1. Office hours Tuesdays at 12pm Pacific

--

1. [Course materials](https://rfortherestofus.com/courses/vsa-r-training-fall-2022/)
...
1. [Google Sheet with contact information etc](https://docs.google.com/spreadsheets/d/1dOmS1x6yo_d_A78gS-cdxDinKX7Hmb1K_8f7dB8VHkY/edit#gid=0)
...
[![](images/rin3-google-sheet.png)](https://docs.google.com/spreadsheets/d/1dOmS1x6yo_d_A78gS-cdxDinKX7Hmb1K_8f7dB8VHkY/edit#gid=0)
