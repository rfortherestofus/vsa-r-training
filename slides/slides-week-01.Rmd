---
title: "Welcome to VSA R Training"
output:
...
If you haven't yet completed the pre-survey, [please do so now](https://forms.gle/JpSFepUULeMySAzk7).
...
**TODO: REDO THE SURVEY**

```{r, echo=FALSE, eval=FALSE}
participants_2022_spring <- read_sheet("https://docs.google.com/spreadsheets/d/1I3jbDqx2CS2n3zOhgsF7m1c9iqIiJtYeNthQD-prQjQ/edit#gid=0") %>% 
  clean_names()

geocoded_participants <- participants_2022_spring %>% 
  select(city, country) %>% 
  geocode(city = city,
          country = country,
          method = "iq")
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
pre_survey_spring_2022 <- pre_survey %>% 
  mutate(year = year(timestamp)) %>% 
  filter(timestamp > ymd("2022-01-01"),
         timestamp < ymd("2022-07-01"),
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
data_viz_expertise <- pre_survey_spring_2022 %>% 
...
```{r, eval=FALSE, echo=FALSE, fig.width=12, fig.height=4, dpi=300}
how_terrified <- pre_survey_spring_2022 %>% 
...
1. Office hours Wednesdays at 12pm Pacific

--

1. [Course materials](https://rfortherestofus.com/courses/r-in-3-months-spring-2022/)
...
1. [GitHub repository](https://github.com/rfortherestofus/rin3-spring-2022) for discussion and code

--

1. [Google Sheet with contact information etc](https://docs.google.com/spreadsheets/d/1I3jbDqx2CS2n3zOhgsF7m1c9iqIiJtYeNthQD-prQjQ/edit#gid=0)
...
[![](images/rin3-google-sheet.png)](https://docs.google.com/spreadsheets/d/1dOmS1x6yo_d_A78gS-cdxDinKX7Hmb1K_8f7dB8VHkY/edit?usp=sharing)

---

## Course Materials

[![](images/rin3-course-page.png)](https://rfortherestofus.com/courses/vsa-r-training-fall-2022/)
...
[Wednesdays at 10:00am Pacific time](https://us02web.zoom.us/j/81833509575?pwd=RkRibWdxUG1EZ1FSS1hMM1J0MU5kZz09)
...
- If you have more general questions, post them in the GitHub discussion forum in the Q&A category
