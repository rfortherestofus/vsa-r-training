---
title: "VSA R Training: Week 7 (Tidy Data)"
output:
...
Tidy data is both a philisophical approach to wrangling data - and a requirement for using parts of the tidyverse.
...
Create a function that can help you do your work more efficiently
